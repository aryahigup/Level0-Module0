...
if __name__ == '__main__':
    ...
    messagebox.showinfo(title='Intro', message="If you find yourself having to cross a piranha-infested river, here's how to do it...")
    # Get the player to enter an adjective
    adj = simpledialog.askstring(title='Input', prompt="Enter an adjective")
    # Get the player to enter a type of liquid
    liquid = simpledialog.askstring(title='Input', prompt="Enter a type of liquid")
    # Get the player to enter a body part
    bodyPart = simpledialog.askstring(title='Input', prompt="Enter a body part")
    # Get the player to enter a verb
    verb = simpledialog.askstring(title='Input', prompt="Enter an verb")
    # Get the player to enter a place
    place = simpledialog.askstring(title='Input', prompt="Enter an place")
